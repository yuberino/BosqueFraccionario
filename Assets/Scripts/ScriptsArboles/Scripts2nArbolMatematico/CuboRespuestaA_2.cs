...
public class CuboRespuestaA_2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.gameObject.CompareTag("Leñador"))
        {
            ...
            int respuestaCorrecta = GameObject.Find("ArbolMatematico2").GetComponent<ArbolMatematico2>().respuestaCorrecta;
            ...
            if (respuestaCorrecta == 1)
            {
                ...
                GameObject Arbre = GameObject.Find("ArbolMatematico2");
                Destroy(Arbre);
                respuestaCorrecta = 0;
                
            } else {
                
                GameObject.Find("ArbolMatematico2").GetComponent<ArbolMatematico2>().Inicialitzar();
                respuestaCorrecta = 0;
                Destroy(GameObject.FindWithTag("Operacion2"));
